...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return pageMetadata({
    locale: loc,
    path: "palmares",
    title: t.pageHeaders.achievements.title,
    description: t.pageHeaders.achievements.metaDescription,
    image: t.pageHeaders.achievements.image,
  });
}
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbJsonLd(locale as Locale, [
              ...
              { name: t.pageHeaders.achievements.title, path: "palmares" },
            ]),
          ),
        }}
      />
